...
const RouteGraph = ({ routeData, shipDetails }) => {
  ...
  return (
    <div className="p-4 md:p-6 bg-slate-950 text-slate-100 h-full overflow-y-auto font-sans">
      <h3 className="text-2xl font-bold mb-6 text-slate-100 text-center sticky top-0 bg-slate-950 py-2 z-10 border-b border-slate-800">
